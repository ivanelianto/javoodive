...
public abstract class Privilege
{
	...
	public interface InterruptPrivilege
	{
		 ...
		 *
		 * @param when
		 *            the number of ticks until the interrupt should occur.
		 * @param type
		 *            a name for the type of interrupt being scheduled.
		 * @param handler
		 ...
		 *
		 * @param inKernelMode
		 *            <tt>true</tt> if the current thread is running kernel
		 *            code, <tt>false</tt> if the current thread is running MIPS
		 *            user code.
		 */
	...
	public interface TCBPrivilege
	{
		 ...
		 *
		 * @param thread
		 *            the thread whose TCB is about to be destroyed.
		 */
