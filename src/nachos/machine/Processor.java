		...
		private void execute() throws MipsException
		{
			...
			switch (operation)
			{
				...
				case Mips.LWL:
					...
					// LWL shifts the input left so the addressed byte is
					// highest
				...
				case Mips.LWR:
					...
					// LWR shifts the input right so the addressed byte is
					// lowest
				...
				case Mips.SWR:
					...
					// SWR shifts the lowest order byte into the addressed
					// position
